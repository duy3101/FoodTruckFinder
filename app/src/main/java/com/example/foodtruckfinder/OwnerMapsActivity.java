...
public class OwnerMapsActivity extends FragmentActivity
        implements OnMarkerClickListener, OnInfoWindowCloseListener, OnInfoWindowClickListener, OnMapReadyCallback
{
...
//                        }
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            // resize marker
            Bitmap b = BitmapFactory.decodeResource(getResources(), R.mipmap.own_foodtruck_foreground);
            ...
            // move map camera if distance > 10 meter ~30 ft
            if (mCurrLocation.distanceTo(location) > 10) {
                mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(latLng, 15));
                mCurrLocation = location;
    ...
    private void searchAround(Location loc) {
        ...
        GeoQuery geoQuery = geoFire.queryAtLocation(new GeoLocation(loc.getLatitude(), loc.getLongitude()), .6);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(OwnerMapsActivity.this,
    ...
    public void onPause()
    {
        ...
        geoFire.removeLocation(userID, new GeoFire.CompletionListener() {
            ...
            public void onComplete(String key, DatabaseError error) {
                if (error != null) {
                    Toast.makeText(getApplicationContext(), "Cannot remove from OnlineOwner", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getApplicationContext(), "Removed from OnlineOwner ", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(OwnerMapsActivity.this,
